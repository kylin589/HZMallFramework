...
using HZMall.Core;
using HZMall.Domain;
using HZMall.Domain.AdminModel.Models.Categoreis;
using HZMall.IServices;
using HZMall.IServices.Products;

namespace HZMall.Service.Products
{
    /// <summary>
    ///     产品类别
    /// </summary> 
    public class CategoryService : BaseService, ICategoryService
    {
        ...
        private void CreateTree1(List<dynamic> categories, int parentId, List<dynamic> categories1)
        {
